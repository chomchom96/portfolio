    ...
    <main className="p-0">
      ...
      <section id="about">
        ...
        <div className="w-4/5 mx-auto bg-white">
          <div className="my-10">
            ...
            <div className="border-4 border-blue-500 rounded-xl p-5 shadow-lg space-y-2">
              <p>
              ...
              <p>
                수많은 도전과 경험을 통해 다양한 기술 스택을 쌓아 적재적소에
                알맞은 기술을 적용하여 최고의 UX를 제공할 수 있는 프론트엔드
                개발자가 되고 싶습니다.
              </p>
            </div>
          </div>
      ...
      <section id="skills">
        <div className="w-4/5 mx-auto bg-white">
          ...
          <div className="flex flex-row justify-around gap-4 border-4 border-cyan-500 rounded-xl my-10 p-5">
